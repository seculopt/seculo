...
(function () {
  ...
  css.textContent = [
    // Colours and type reference the :root variables in css/style.css so the
    // banner tracks the brand palette instead of drifting from it.
    '#seculo-cookie-banner{',
      'position:fixed;bottom:0;left:0;right:0;z-index:9999;',
      'background:var(--brand-dark);border-top:2px solid var(--brand-terracotta);',
      'padding:16px 24px;',
    '}',
    ...
    '#seculo-cookie-banner .cb-text{',
      'color:rgba(240,238,232,0.8);font-size:0.875rem;line-height:1.6;',
      'flex:1;min-width:180px;',
      'font-family:var(--font-body);',
    '}',
    '#seculo-cookie-banner .cb-text a{color:var(--color-accent-on-dark);text-decoration:underline;}',
    ...
    '#seculo-cookie-banner .cb-essential{',
      ...
      'border:1.5px solid rgba(240,238,232,0.45);',
      'color:rgba(240,238,232,0.8);',
    '}',
    '#seculo-cookie-banner .cb-essential:hover{',
      'border-color:var(--color-accent-on-dark);color:var(--color-on-dark);',
    '}',
    '#seculo-cookie-banner .cb-accept{',
      'background:var(--brand-terracotta);border:1.5px solid var(--brand-terracotta);',
